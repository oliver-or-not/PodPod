...
class StatusModel {
    ...
    static let initialValueOfMainMenuBoolArray = [true, true, true, false, false, false, false, false, false, true, true]
    // 0...2: music, photos, videos
    // 3...8: playlists, artists, albums, songs, composers, libraryRefresh
    // 9: settings
    // 10: shufflesongs
