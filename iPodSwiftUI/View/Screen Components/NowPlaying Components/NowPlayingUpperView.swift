...
struct NowPlayingUpperView_Previews: PreviewProvider {
    static var previews: some View {
        NowPlayingUpperView(currentSongIndex: 0, lineupCount: 3, repeatState: .all, shuffleIsActivated: true, currentSongTitle: "야생화", currentSongArtistName: "박효신", currentSongAlbumTitle: "야생화", upperTextFlicker: true, upperTextOffsetTrigger: false)
    }
}
